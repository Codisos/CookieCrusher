...
namespace KetosGames.SceneTransition
{
    public class SceneLoader : MonoBehaviour
    {
        ...
        IEnumerator InnerLoad(Scene scene)
        {
            ...
            {
                SceneLoadingOperation = UnityEngine.SceneManagement.SceneManager.LoadSceneAsync(scene.SceneName);
            }
            else
            {
                SceneLoadingOperation = UnityEngine.SceneManagement.SceneManager.LoadSceneAsync(scene.BuildIndex);
            }
